      ...
      <div className="col-span-12 grid grid-cols-12 gap-6 self-start xl:col-span-8">
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 lg:col-span-4">
            <a href="#"><h3 className="mb-2.5 text-2xl font-bold lg:text-[28px]">
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4 lg:col-span-8">
          ...
          <div className="col-span-12 md:col-span-6">
            <a href><h3 className="mb-2.5 text-xl font-bold lg:text-2xl">
        ...
        <div className="space-y-6 divide-y-2 divide-[#D5D1C9]">
          ...
          <div className="col-span-12 mb-6 md:col-span-8">
            ...
            <div className="col-span-12 mt-6 md:col-span-4">
              <a href="#"><h3 className="mb-2.5 text-xl font-bold lg:text-[20px]">
